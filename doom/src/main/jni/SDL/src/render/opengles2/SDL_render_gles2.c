...
*/
	rdata->glViewport(0, 0,Android_ScreenWidth_Actual, Android_ScreenHeight_Actual);
...
GLES2_SetOrthographicProjection(SDL_Renderer *renderer)
{
   ...
   // projection[0][0] = 2.0f / 1000;
    projection[0][1] = 0.0f;
    projection[0][2] = 0.0f;
    projection[0][3] = 0.0f;
    projection[1][0] = 0.0f;
    projection[1][1] = -2.0f / renderer->viewport.h;
    //projection[1][1] = -2.0f / 240;
    projection[1][2] = 0.0f;
    projection[1][3] = 0.0f;
    projection[2][0] = 0.0f;
    projection[2][1] = 0.0f;
...
GLES2_RenderFillRects(SDL_Renderer *renderer, const SDL_Rect *rects, int count)
{
    ...
    for (idx = 0; idx < count; ++idx) {
        ...
        LOGI("GLES2_RenderFillRects %d %d %d %d ",rect->x,rect->y,rect->w,rect->h);
...
GLES2_RenderCopy(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_Rect *srcrect,
                 const SDL_Rect *dstrect)
{
	LOGI("GLES2_RenderCopy: TEX %d,%d   SCR %d,%d,%d,%d    DEST %d,%d,%d,%d",texture->w,texture->h,srcrect->x,srcrect->y,srcrect->w,srcrect->h,dstrect->x,dstrect->y,dstrect->w,dstrect->h);
