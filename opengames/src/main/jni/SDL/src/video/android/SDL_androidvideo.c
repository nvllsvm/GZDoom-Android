...
int Android_ScreenWidth_Actual = 0;
int Android_ScreenHeight_Actual = 0;
...
*/
	...
	width=320; //EMILE HACK
	height=240;

	//width=640; //EMILE HACK
	//height=480;
...
void
Android_SetGameResolution(int width, int height)
{
